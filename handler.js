...
module.exports = {
    async handler(chatUpdate) {
        ...
        global.wm = namabot + '-Nᴇᴏ-Mᴅ'
        global.colong1 = 'Ciss 📸'
        global.colong2 = 'Jgn Lupa Sv Kontak Owner Gamteng😎 : 6285600380823'
        global.kontak2 = [
        ['6285600380823', 'Fᴀɪsᴀʟ', 'ᴅᴇᴠᴇʟᴏᴩᴇʀ ʙᴏᴛ', 'ryanndevelopment@gmail.com ', true],
        ['6285600380823', await this.getName('6283823916413@s.whatsapp.net'), 'owner1', 'rafilukmanufaizal@gmail.com', false],
        ['6282153954737', 'Yann-Bot', 'Bot WhatsApp', 'Nothing!', true],
        ['6285600380823', await this.getName('6282153954737@s.whatsapp.net'), 'owner2', 'rafilukmanufaizal@gmail.com', false],
                    ...
                    for (let user of participants) {
                        ...
                        try {
                            ...
                            let wel = API('hardianto', '/api/welcome3', {
                                ...
                                bg: 'https://telegra.ph/file/87b77b792df30c6176315.jpg',
